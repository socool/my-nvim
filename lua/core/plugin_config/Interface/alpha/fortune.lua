...
local fortune_list = {
	...
	{ "There’s no need to show off when you know who you are", "", "- MaximeLagacé" },
	...
	{ "Be humble, hungry and the hardest worker in the room", "", "- Dwayne The Rock Johnson" },
	{ "Without patience, there can be no genius", "", "- Robin Sharma" },
